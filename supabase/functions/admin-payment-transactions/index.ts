...
serve(async (req) => {
  ...
  try {
    ...
    let query = supabaseClient
      ...
      .select('*, users!payment_transactions_user_id_fkey(full_name, phone)', { count: 'exact' })
    ...
    if (search) {
      query = query.or(`provider_reference.ilike.%${search}%,provider_transaction_id.ilike.%${search}%`);
    }
