...
export const metadata: Metadata = {
  title: "Testimonials",
  description: "Hear from real users about their experience with Juli Smart Susu.",
};

const testimonials = [
  { name: "Ama Serwaa", location: "Osu, Accra", text: "Juli Smart Susu helped me save enough to stock my provisions shop. The daily reminders kept me accountable, and the MoMo payments are so convenient. I've now completed 3 cycles!", rating: 5, saved: "GHS 4,500" },
      ...
      <section className="bg-gradient-to-b from-navy-50 to-white dark:from-navy-950 dark:to-navy-900 py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Real stories from real Ghanaians who are building their financial future with Juli Smart Susu.
          </p>
        </div>
      </section>
